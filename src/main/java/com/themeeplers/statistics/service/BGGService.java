...
import com.themeeplers.statistics.model.api.bgg.item.ItemList;
...
public class BGGService {
    ...
    public ItemList getGame(final long id) {
        XmlMapper mapper = new XmlMapper();
        return template.getForObject("https://www.boardgamegeek.com/xmlapi2/thing?stats=1&id=" + id, ItemList.class);
    }

    public static void main(String[] args) {
        try {
            BGGService service = new BGGService();
            ItemList game = service.getGame(178900);
